document.addEventListener("DOMContentLoaded", function () {
    ...
    function showJobDetails(jobData) {
        ...
        let description = jobData.long_description || '';  // Use empty string if undefined or null

        // Truncate description if longer than 400 characters
        ...
        sidebarContentInner.innerHTML = `
            ...
            <p><strong>Description:</strong> ${description}</p>  <!-- Use the truncated description -->
